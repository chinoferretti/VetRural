...
import vetrural.mvc.service.MetricasService;
import java.net.URI;
...
public class EstablecimientoController {
    ...
    public MetricasResponse getMetricas(
        ...
        return metricasService.calcular(id, sexo, lote);
    }

    @GetMapping("/{id}/usuarios")
    public List<UsuarioResponse> getUsuarios(@PathVariable Long id) {
        return establecimientoService.getUsuarios(id).stream()
