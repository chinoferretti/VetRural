      ...
      {tabActiva === 'clinicos' && (
        <div className="flex flex-col gap-5">
          ...
          <SeccionClinica titulo="Vacunación" icono="💉">
            {['Aftosa','Brucelosis','Carbunco','Clostridial','IBR','BVD'].map(nombre => {
              const vac = vacunas.find(v => v.vacuna === nombre);
              return <Campo key={nombre} label={nombre} valor={vac ? formatFecha(vac.fechaHora) : null} />;
            })}
          </SeccionClinica>
