...
const handleSubmit = async (e) => {
  ...
  try {
    ...
    const registradoPorId = 1; // por ahora fijo, después viene del usuario logueado
console.log('datos pesaje:', { bovinoId, registradoPorId, peso: Number(form.peso) });
console.log('tipos:', typeof bovinoId, typeof registradoPorId);
    // 2. Pesaje (si completó el peso)
    if (form.peso) {
      await api.post('/manga/pesaje', { bovinoId, registradoPorId, peso: Number(form.peso) });
    }

    // 3. Tacto (si completó situación)
